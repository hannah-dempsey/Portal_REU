...
```{r}
avg_precip <- ggplot(weather_avg, aes(x = year, y = avg_precip)) +
  geom_point() +
  geom_line() +
...
Using patchwork to compare biomass with weather:

```{r}
portal_total_biomass / avg_precip & scale_x_continuous(limits = c(1979, 2025))
```
...
weather_ecol(total_biomass_annual, biomass_g, weather_avg, avg_precip, 1500)
```
